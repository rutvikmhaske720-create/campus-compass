...
//         {/* Glow behind */}
//         <div className="absolute top-0 right-0 w-64 h-64 bg-purple-500/5 rounded-bl-full filter blur-xl pointer-events-none" />

//         <div className="flex flex-col md:flex-row items-center gap-8 w-full md:w-auto">
//           {/* Mapped SVG Fallback illustration */}
//           <div className="w-32 h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden shrink-0 border border-slate-200 shadow-lg">
//             <img
//               src={fallbackSVG}
//               alt={club.name}
